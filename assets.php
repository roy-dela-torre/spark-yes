...
function theme_enqueue_all_assets()
{
    ...
    // ✅ Preload output.css for faster styling (hooked into wp_head manually)
    add_action('wp_head', function () use ($theme_dir) {
        echo '<link rel="preload" as="style" href="' . $theme_dir . '/src/output.css" />';
    }, 1);
