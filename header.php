...
<body <?php echo body_class(); ?>>
    <header class="fixed top-0 left-0 w-full z-50 border-solid border-[1px]" style="border-color: rgba(255, 255, 255, 0.10);" id="mainHeader">
        <nav class="flex flex-wrap items-center justify-between mx-auto border-white/10">
            <a href="<?php echo get_home_url(); ?>" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img loading="laxy" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/global/header_logo.png" class="h-8" alt="Spark Yes" />
            </a>
                ...
                wp_nav_menu(array(
                    ...
                    'walker' => new class extends Walker_Nav_Menu {
                        function start_el(&$output, $item, $depth = 0, $args = null, $id = 0)
                        {
                            ...
                            $classes[] = 'py-[10px] lg:py-[38px] relative'; // Add your custom li class here
